				...
				<form action="infoAdded" method="post">
					<div class="top-section">
						<input type="text" id="projectName" name="projectName"
							placeholder="Enter Project Theme"></input>
						<button class="form-submit-btn" type="submit">Save
							Project</button>
					</div>
					<div class="lower-section">
						...
						<div class="input-div">
							...
							<p id="dateError" style="color: red; display: none;">End date
								is smaller than the start date</p>
						</div>
						<div class="input-div">
